...
experienced by other projects on Titan. \jhanote{the following is a very
strong statement. Discuss} \seannote{Discussed with more words, but it's one
of those ``true by definition'' moments in a math proof, so I hope I'm
capturing it in words.} As shown in Figure~\ref{fig:monthly-consumption},
