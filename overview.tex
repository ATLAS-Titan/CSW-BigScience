...
In PanDA's data model, each datum refers to a recorded or simulated measurement
...
Once derived, jobs are collected into the Job Buffer, waiting to be bound to a
